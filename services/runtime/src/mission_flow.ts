...
export interface MissionFlowResponse {
  ...
  settlementPath?: "runtime_fallback_required";
...
const defaultBudgetUsd = "0.10";
const defaultResourceUrl = "https://127.0.0.1:4010/paid/report?topic=market-intel";
const demoWalletUuid = "runtime-demo-wallet";
const demoWalletAddress = "0xCAW0000000000000000000000000000000000001";
const demoPactId = "runtime-demo-pact";
...
const demoProvider: ProviderRegistryEntry = {
  ...
  facilitatorUrl: "https://facilitator.clear402.local/x402",
  chainId: "84532",
  tokenId: "USDC",
...
export function dryRunMission(database: DatabaseSync, missionId: string): MissionFlowResponse {
  ...
  recordGuardEvent(database, {
    ...
    reason: "Dry-run generated a runtime fallback x402 challenge; no CAW payment was attempted.",
    evidenceJson: {
      source: "runtime_api",
      evidenceMode,
      rawChallenge,
