...
- Updated at: `2026-06-14T02:56:16Z`
- Evidence mode: `live`
- Live ready: `true` for the recorded Sepolia testnet allow-path tiny transfer, the recorded Sepolia testnet policy-denial evidence, the narrowly scoped `message_sign` typed-data allow/deny verification, and one Base Sepolia USDC EIP-3009 `transferWithAuthorization` execution
...
| `eip3009_usdc_transfer_with_authorization` | `verified` | `live` | `evidence/caw/eip3009_usdc_20260614T022751Z/onchain_submission_summary.json`, `evidence/caw/eip3009_usdc_20260614T022751Z/receipt.json`, `evidence/caw/eip3009_usdc_20260614T022751Z/onchain_tx_get_final.result.json`, `evidence/caw/eip3009_usdc_20260614T022751Z/contract_call_pact_events_after_approval.stdout.txt` | EIP-3009 USDC transfer executed on Base Sepolia through CAW-approved contract_call. Fresh message-sign pact `219f8499-bafa-40aa-b6e8-41b41824fbc4` produced a one-time EIP-712 signature for nonce `0xa0ea67f1141a87205c6fb371097fd97d86604fe3b2e5a1b8d418215113bdfe90`; contract_call pact `09ae9ce3-68ee-43f7-b0bb-69cec3a01fce` submitted `transferWithAuthorization` to `0x036CbD53842c5426634e7929541eC2318f3dCF7e`. Tx `0x91f1e0284380b6d50201c95b540e46a68c43cfe0f8e3a5a0c10a3c43fb222b6a` succeeded on Base Sepolia; source balance moved `20000000 -> 19999999`, recipient balance moved `20000000 -> 20000001`, and `authorizationState` moved `false -> true`. |
...
Clear402 may claim one live CAW Sepolia testnet allow-path tiny transfer, one live CAW Sepolia testnet destination-allowlist policy denial, the official x402 HTTP 402 / dry-run round-trip, the official payment-gateway startup/forwarding path, one narrowly scoped live CAW `message_sign` typed-data allow/deny verification for pact `6c27d578-df51-488c-862f-55475bc01190`, one live CAW EIP-712 USDC authorization verification for Base Sepolia pact `4ae3f7a8-ee69-4174-83b5-1063548f9fe2`, and one EIP-3009 USDC transfer executed on Base Sepolia through CAW-approved contract_call. It must not claim production readiness, mainnet execution, unrestricted wallet access, successful official x402 execute, successful payment execution beyond the recorded allow-path smoke and exact Base Sepolia EIP-3009 tx, payment gateway settlement, or coverage for every possible CAW policy-denial type.
...
Fresh Base Sepolia USDC EIP-3009 execution evidence is indexed in `evidence/caw/eip3009_usdc_20260614T022751Z/onchain_submission_summary.json`; it verifies exactly one on-chain `transferWithAuthorization` execution through CAW-approved contract_call.
