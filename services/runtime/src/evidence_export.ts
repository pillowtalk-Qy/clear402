  ...
  return {
    ...
    providerChallenge: {
      provider: {
        ...
        chainId: "84532",
        tokenId: "USDC",
        publicKeyHash: hashObject("0x04cawdemo_public_key"),
    ...
    guard: {
      ...
      reason: "Demo fixture guard decision; no CAW payment executed by export.",
      createdAt: now,
      evidenceMode: "fallback",
      eventCount: 1,
      events: [
...
function buildLimitations() {
  return {
    ...
    claimsForbidden: [
      "Do not claim mainnet CAW execution.",
